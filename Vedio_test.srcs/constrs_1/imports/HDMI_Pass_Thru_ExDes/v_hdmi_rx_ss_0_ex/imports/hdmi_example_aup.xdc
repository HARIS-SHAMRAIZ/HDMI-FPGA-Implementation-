...
#####
## Clock signal
set_property -dict {PACKAGE_PIN J11 IOSTANDARD LVCMOS33} [get_ports llc_buffered]
#set_property IOSTANDARD LVCMOS33    [get_ports "CLICK_SPI_CS1_AN"] ;    # Bank 85 - VCCO_85 - IO_L3N_AD13N_85 - CLICK A/D CONVERTER U27-5    
#set_property IOSTANDARD LVCMOS33 [get_ports "llc"]
create_clock -period 37037 -name llc_clk [get_ports llc_buffered]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets llc_buffered_IBUF]
## ButtonsH9
set_property -dict {PACKAGE_PIN K10 IOSTANDARD LVCMOS33} [get_ports pix_in[0]]
set_property -dict {PACKAGE_PIN H11 IOSTANDARD LVCMOS33} [get_ports pix_in[1]]
## Pmod Header JA
set_property -dict {PACKAGE_PIN G11 IOSTANDARD LVCMOS33} [get_ports  pix_in[2]]
set_property -dict {PACKAGE_PIN G10  IOSTANDARD LVCMOS33} [get_ports  pix_in[3]]
set_property -dict {PACKAGE_PIN G9 IOSTANDARD LVCMOS33} [get_ports pix_in[4]]
set_property -dict {PACKAGE_PIN J9 IOSTANDARD LVCMOS33} [get_ports pix_in[5]]
set_property -dict {PACKAGE_PIN K9  IOSTANDARD LVCMOS33} [get_ports pix_in[6]]
set_property -dict {PACKAGE_PIN J10  IOSTANDARD LVCMOS33} [get_ports pix_in[7]]
...
set_property SEVERITY {Warning} [get_drc_checks CASC-49]
set_property IS_ENABLED false [get_drc_checks CASC-49]