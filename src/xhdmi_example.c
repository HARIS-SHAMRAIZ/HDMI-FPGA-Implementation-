...
//#if (!defined XPS_BOARD_ZCU104)
	...
	i2c_tmds181_write(XPAR_IIC_0_BASEADDR, 0x09, 0x02);
...
//			XGpio_LookupConfig(XPAR_V_TPG_SS_0_AXI_GPIO_DEVICE_ID);
        	XGpio_LookupConfig(XPAR_V_TPG_DEVICE_ID);
	...
	Tpg_ConfigPtr = XV_tpg_LookupConfig(XPAR_V_TPG_DEVICE_ID /*XPAR_V_TPG_SS_0_V_TPG_DEVICE_ID*/);
